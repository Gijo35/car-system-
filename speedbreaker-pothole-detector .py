...
def countVehicles(param):
    ...
    ct = CentroidTracker(maxDisappeared=5,
                         maxDistance=50)  # Look into 'CentroidTracker' for further info about parameters
    ...
    with tf.Session() as sess:
        ...
        while (cap.isOpened()):
            ...
            for (objectID, centroid) in objects.items():
                ...
                drawTextCV2(output_img, object_id, (centroid[0] - 10, centroid[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                            (0, 255, 0), 1)
