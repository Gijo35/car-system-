...
st.set_page_config(
    page_title="Drowsiness Detection | Gijo35",
    page_icon="https://github.com/Gijo35/Driver-Drowsiness-detection-using-Mediapipe-in-Python",
    layout="wide",  # centered, wide
    initial_sidebar_state="expanded",
    menu_items={
        "About": "### https://github.com/Gijo35/Driver-Drowsiness-detection-using-Mediapipe-in-Python",
    },
)
...
# https://github.com/Gijo35/Driver-Drowsiness-detection-using-Mediapipe-in-Python
